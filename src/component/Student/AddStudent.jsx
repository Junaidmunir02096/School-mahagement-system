                    ...
                    <div className="w-[100%]">
                        ...
                        <div className="mb-[20px]">
                            ...
                            <textarea
                                ...
                                rows="6"
                                maxLength="1000"
                                className="w-full px-[20px] py-[12px] border border-[#E0E0E0] rounded-[4px] outline-none focus:border-[#4D44B5] transition-colors text-[14px] text-[#303972] placeholder-[#A098AE] resize-none"
                            />
                        </div>
